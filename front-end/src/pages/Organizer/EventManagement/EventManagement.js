    ...
    return (
        <div className={styles["event-management"]}>
            <div className={styles["sidebar"]}>
                ...
                <div>
                    <h2>Report</h2>
                    <Link to={`/organizer/myevents/${eventId}/summary`}><i class="fas fa-chart-pie"></i> Summary</Link>
                    <a href="#"><i class="fas fa-bullhorn"></i> Analysis</a>
                    <Link to={`/organizer/myevents/${eventId}/order-list`}><i class="fas fa-list"></i> Order List</Link>
                </div>
                <div>
                    <h2>Event setting</h2>
                ...
                <div>
                    <h2>Marketing</h2>
                    <Link to={`/organizer/myevents/${eventId}/voucher`}><i class="fas fa-cog"></i> Promotion</Link>
                </div>
            </div>
